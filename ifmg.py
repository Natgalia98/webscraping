...
tecnologia_ifmg=requests.get('https://mais.ifmg.edu.br/maisifmg/course/index.php?categoryid=10')

url_curso_ifmg='/course/view.php?id='

curso_tecnologia_ifmg=BeautifulSoup(tecnologia_ifmg.text,'html.parser')

print("\nCurso de Informática - IFMG\n")
